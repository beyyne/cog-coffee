...
function getFallbackMenu() {
  return [
    ...
    { id: 'tea-003', name: 'Chamomile', description: 'Organic chamomile from Spirit Tea. Honey, dried apple, baby\'s breath. Caffeine-free.', category: 'tea' },
    ...
    { id: 'tea-006', name: 'Green Tea', description: 'Kodama Sencha from Spirit Tea. Fukuoka, Japan. Toasted nori, sesame, honeydew.', category: 'tea' },
